                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                              <select class="w-25 js-basic-single-videocard" name="video_card" id="videocard">
                                    <option></option>
                            ...
                            <div class="mb-4">
                                <select class="w-25 js-basic-multiple-ram" name="ram_memory" id="ram_memory">
                                    <option></option>
                            ...
                            <div><label for="sliderdisplay">Display Size (inches)</label><input type="text" id="sliderdisplay" class="slider" hidden></div>
